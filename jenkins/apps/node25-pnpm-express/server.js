...
<html>
<head><title>Chainguard Node Demo (slim)</title></head>
<body>
<h1>Hello from Node on Chainguard (slim)</h1>
<h2>Runtime info</h2>
<table border="1" cellpadding="4">
  ...
  <tr><td>nanoid.instance</td><td>${instanceId}</td></tr>
...
if (require.main === module) {
  ...
  app.listen(port, '0.0.0.0', () => {
    console.log(`[${instanceId}] Listening on http://0.0.0.0:${port}/`);
  });
}
